# Originally, created by https://github.com/erykml
# were found in https://github.com/erykml/medium_articles/blob/master/Machine%20Learning/prediction_strength.ipynb
import numpy as np
import sys
